...
class StoryList {
  ...
  // Removes a story from API and the story list.
  ...
  async removeStory(user, storyId) {
    ...
    // Find the index of the new story in the 'stories' array
    let index = this.stories.findIndex(story => story.storyId == storyId);
    console.debug('index = ', index);
    console.debug(this.stories[index]);
    // Remove the story from the 'stories' array
    if (index !== -1) {
        this.stories.splice(index, 1);
    }
    // Find the index of the new story in the 'stories' array
    index = user.ownStories.findIndex(story => story.storyId == storyId);
    console.debug('index = ', index);
    console.debug(user.ownStories[index]);
    // Remove the story from the 'stories' array
    if (index !== -1) {
...
class User {
  ...
  // Add function that allows user to "favorite" a story. 
  ...
  // Add function that allows user to "unfavorite" a story. 
